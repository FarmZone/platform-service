...
from farmzone.buyers.views.user import MySellersViewSet, UnassociatedSellersView, AddSellerView, RegisterBuyerDeviceView
...
urlpatterns = [
    ...
    url(r'buyer/(?P<user_id>[\w]+)/register_buyer_device/?$', RegisterBuyerDeviceView.as_view()),
]
